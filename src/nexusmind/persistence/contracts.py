...
class RunRecorder(Protocol):
    ...
    async def finish_run(self, run_id: str, status: RunStatus, *, error_code: str | None = None, error_message: str | None = None, trace_complete: bool | None = None, final_text: str | None = None) -> None: ...
